...
param_file << "constant_volume : " << params.constant_volume << "\n";
param_file << "constant_pressure : " << params.constant_pressure << "\n";
param_file << "pressure_time : " << params.pressure_time << "\n";
param_file << "target_pressure : " << params.target_pressure << "\n";
param_file << "target_radius : " << params.target_radius << "\n";
param_file << "compressibility : " << params.compressibility << "\n";
param_file << "ss_a : " << params.ss_a << "\n";
param_file << "ss_rs : " << params.ss_rs << "\n";
param_file << "ss_eps : " << params.ss_eps << "\n";
param_file << "filament_spiral_flag : " << params.filament_spiral_flag << "\n";
