#ifndef _SIMCORE_INTERACTION_ENGINE_V2_H_
#define _SIMCORE_INTERACTION_ENGINE_V2_H_
...
class InteractionEngineV2 {
  public:
    InteractionEngineV2() {}
    virtual ~InteractionEngineV2() {}
...
#endif /* _SIMCORE_INTERACTION_ENGINE_V2_H_ */
