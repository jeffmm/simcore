...
void RigidMesh::SetInteractorLength(double const len) {
  ix_length_ = len;
}
void RigidMesh::SetInteractorDiameter(double const d) {
  ix_diameter_ = d;
}
...
double const RigidMesh::GetInteractorLength() {
  return ix_length_;
}
double const RigidMesh::GetInteractorDiameter() {
  return ix_diameter_;
}
double const * const RigidMesh::GetInteractorPosition() {
  return ix_position_;
}
