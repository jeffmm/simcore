...
void DynamicInstabilityKMCV2::Init(space_struct *pSpace,
...
void DynamicInstabilityKMCV2::Print() {
...
void DynamicInstabilityKMCV2::Dump() {
  if (debug_trace) {
    std::cout << "DynamicInstabilityKMCV2 -> dump\n";
  }
}

void DynamicInstabilityKMCV2::StepKMC() {
  UpdatePolymerizationState();
  GrowBonds();
}

void DynamicInstabilityKMCV2::UpdatePolymerizationState() {
  BrRodSpecies *prspec = dynamic_cast<BrRodSpecies*>(spec1_);
...
void DynamicInstabilityKMCV2::GrowBonds() {
  BrRodSpecies *prspec = dynamic_cast<BrRodSpecies*>(spec1_);
  //std::cout << "GrowBonds\n";
  auto rod_members = prspec->GetMembers();
