...
void parse_params(YAML::Node node, system_parameters *params) {
  ...
  for (YAML::const_iterator it = node.begin(); it != node.end(); ++it) {
    if (it->second.IsMap()) {
      ...
      if (false) {
        ...
        for (YAML::const_iterator jt = it->second.begin();
          ...
          if (false) {
            ...
            std::cout << "  WARNING! Unrecognized " << struct_name
        ...
        for (YAML::const_iterator jt = it->second.begin();
          ...
          if (false) {
            ...
            params->filament.spiral_number_fail_condition =
                jt->second.as<double>();
          ...
          } else if (param_name.compare("force_induced_catastrophe_flag") ==
                     0) {
            params->filament.force_induced_catastrophe_flag =
                jt->second.as<int>();
        ...
        for (YAML::const_iterator jt = it->second.begin();
          ...
          if (false) {
            ...
            params->passive_filament.persistence_length =
                jt->second.as<double>();
          } else if (param_name.compare("max_length") == 0) {
            ...
            params->passive_filament.insertion_type =
        ...
        for (YAML::const_iterator jt = it->second.begin();
          ...
          if (false) {
            ...
            params->spherocylinder.insertion_type =
                jt->second.as<std::string>();
          } else if (param_name.compare("insert_file") == 0) {
      ...
      } else if (param_name.compare("species_insertion_failure_threshold") ==
                 0) {
