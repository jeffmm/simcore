...
class InteractionEngine {
 private:
  double stress_[9], dr_update_;
  bool overlap_, no_interactions_,
      no_init_ = true, processing_ = false,
      /* For measuring incoming and outgoing angles of crossing filaments */
      in_out_flag_ = false;
  int n_dim_, n_periodic_, i_update_, n_update_, n_objs_, n_thermo_,
      static_pnumber_, *i_step_, n_interactions_;
  ...
  void ProcessBoundaryInteraction(
