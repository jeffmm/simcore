...
// where friction tensor Xi = friction_par * |u><u| + friction_perp * (I -
// |u><u|), u is the orientation, F_s is the force from interactions, and dr(t)
// is the random displacement due to random force,
